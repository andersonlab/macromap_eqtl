...
rule run_coloc:
	...
	shell:
		"Rscript {config[general_path]}/scripts/GWAS_run_coloc.R "
		...
		"--gwaslist {config[gwas_list]} --chunk {params.chunks}  --numberGWAS {config[numberGWAS]} --function_path_source {config[general_path]}/scripts/functions_me.R"
