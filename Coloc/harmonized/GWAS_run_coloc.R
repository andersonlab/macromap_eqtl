...
#source("/nfs/users/nfs_n/np12/myscratch/MacroMap/Analysis/Coloc_analysis/Macromap_fds/coloc_new_gwas/MacroMap/scripts/harmonized/functions_me.R")
...
option_list <- list(
  ...
  make_option(c("--gwastype"), type="character", default=NULL,
               help="gwastype", metavar = "type"),
...
#Debugging
# opt = list(gwas = "RA", w = "2e6", p = "featureCounts", d = "/lustre/scratch117/cellgen/team170/np12/MacroMap/Data/GWAS/GWAS_catalogJuly20/All_files/1.Autoimmune_Inflamatory_disease/harmonized/",
#            o = "/nfs/users/nfs_n/np12/myscratch/MacroMap/Analysis/Coloc_analysis/Macromap_fds/coloc_new_gwas/MacroMap/coloc_out/",
#            qtl = "/nfs/users/nfs_n/np12/myscratch/MacroMap/Analysis/eQTLs/Macromap_fds/analysis/eQTLs_per_TSS/1MB/",
#            s = "/lustre/scratch117/cellgen/team170/np12/MacroMap/Analysis/eQTLs/Macromap_fds/analysis/eQTLs_per_TSS/sample_size_per_condition/IFNG_6",
#            gwasvarinfo = "/lustre/scratch117/cellgen/team170/np12/MacroMap/Data/Genotypes/vcf_hipsci_hg38/DS_Filt_M/chr_position_ID_major_minor_MAF_v37v2.txt.gz",
#            qtlvarinfo = "/lustre/scratch117/cellgen/team170/np12/MacroMap/Data/Genotypes/vcf_hipsci_hg38/DS_Filt_M/chr_position_ID_major_minor_MAF.txt.gz",
#            gwaslist = "/lustre/scratch117/cellgen/team170/np12/MacroMap/Data/GWAS/GWAS_catalogJuly20/All_files/1.Autoimmune_Inflamatory_disease/harmonized/1.Autoimmune_Inflamatory_disease_gwas_files.txt",
#            chunk=6,gwastype="GWASCatalog")
...
qtl_df_list = prefilterColocCandidates(phenotype_values$min_pvalues, gwas_prefix,
                                       ...
                                       overlap_dist =cis_window, gwas_thresh = 1e-5,gwas_type=gwastype)
...
coloc_res_list = purrr::map2(phenotype_values$qtl_summary_list, phenotype_values$sample_sizes,
                             ~colocMolecularQTLsByRow_nikos(qtl_pairs, qtl_summary_path = .x,
                                                            ...
                                                            N_qtl = .y, cis_dist = cis_window,N=numberGWAS,gwas_type=gwastype))
